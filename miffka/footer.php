    ...
    <div class="row">
      ...
      <div class="menu-footer">
        <ul class="main-menu">
          ...
          <li class="menu-item"><a href="<?php if(!is_front_page()){ echo get_home_url(); } ?>#portfolio">Портфоліо</a>
          </li>
          <li class="menu-item">
      ...
      <div class="contact-footer">
        <a href="tel:+<?= preg_replace('/[^0-9]/', '', get_field('phone_set', 'option')); ?>" class="phone-footer">
        ...
        <a href="mailto:<?= get_field('email_set', 'option'); ?>" class="mail-footer">
          ...
          <span><?= get_field('email_set', 'option'); ?></span>
        </a>
      </div>
    </div>
...
<div id="contact_us_pop_up" class="block-form fancybox-content" style="display: none;">
  <div class="block-form-wrap">
    <h4 class="block-form__title">Зв'яжіться з нами</h4>
    <p class="block-form__text">Просто заповніть коротку форму і наш менеджер зв’яжеться з вами найближчим часом</p>
    <?= do_shortcode( '[contact-form-7 id="5" title="Contact us popup"]' ); ?>
  </div>
</div>
